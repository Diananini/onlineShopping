<%@ page language="java" import="java.util.*,com.eshore.factory.*,com.eshore.pojo.*,com.eshore.dao.*,com.eshore.service.*" pageEncoding="UTF-8"%>
									...
									<div>
										...
										<table style="padding-left: 10%">
											<tr>
												...
												<td>
												<select id="usedAddr" name="usedAddr">
													<option value="0" selected="selected">
																-历史地址-
													</option>
													<%
													Vector<Correspond> corrVector=new Vector<Correspond>();
													corrVector=DAOFactory.getCorrespondDAOInstance().queryByUid(Integer.parseInt(String.valueOf(session.getAttribute("uid"))));
													Iterator<Correspond> it=corrVector.iterator();
													while(it.hasNext()){
